        ...
        <div className="relative aspect-square overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 flex items-end justify-center pb-4">
            <button
              ...
              className="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
              <ShoppingCart className="h-4 w-4" />
              <span>{isLoading ? 'Adicionando...' : 'Adicionar'}</span>
            </button>
          </div>
        </div>
      </Link>
